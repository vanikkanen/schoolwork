...
/** EVENT TURN_OUT */
public final EventOutput TURN_OUT = new EventOutput();
/** EVENT UNLOAD_CNV_1 */
public final EventOutput UNLOAD_CNV_1 = new EventOutput();
/** EVENT LOAD_CNV_2 */
public final EventOutput LOAD_CNV_2 = new EventOutput();
...
void state_FULL(){
   ...
   TURN_OUT.serviceEvent(this);
   UNLOAD_CNV_1.serviceEvent(this);
}
